...
| O quê | Fonte |
| --- | --- |
| Composição dos 646 ingredientes | **Tabela da Composição de Alimentos do INSA** (PortFIR, v7.1, 2026), transcrita campo a campo |
| Ingredientes que a tabela portuguesa não cobre | **USDA FoodData Central** e **TACO**, convertidos para hidratos *disponíveis* (convenção europeia) |
