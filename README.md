...
**Nutrição do bebé por percentil** — nos perfis de bebé, o separador Nutrição dá lugar a um módulo próprio. As curvas de peso para a idade da OMS (percentis 3 a 97) aparecem desenhadas com o bebé assinalado, e arrastar o slider do peso move o ponto e recalcula tudo. As doses diárias de referência (energia, proteína, hidratos, gordura, água, ferro, cálcio, vitamina D) seguem as equações da IOM e as RDA/AI do escalão.

O leite tem a sua ferramenta: modo (materno, fórmula, misto, leite + sólidos), sliders de tomadas por dia e volume por tomada — que parte das necessidades de energia e é validado contra o intervalo habitual de 120–200 ml/kg/dia — e, na fórmula, a conversão em medidas com o aviso de nunca alterar a diluição. O horário das tomadas gera-se com dois sliders (intervalo de 2 a 6 horas e hora da primeira toma) e desenha-se numa linha do dia com a noite sombreada. A partir dos 6 meses, um slider reparte a energia entre leite e sólidos e o dia é sugerido em refeições (papa a meio da manhã, sopa e prato ao almoço…), com as regras do primeiro ano à vista: sem sal, sem açúcar, sem mel.
