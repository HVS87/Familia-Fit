...
**🍳 Receitas** — separador próprio com **227 receitas** de oito cozinhas: portuguesa, mediterrânica, espanhola, italiana, francesa, mexicana, norte-americana e asiática, com pratos principais, pequenos-almoços e lanches em todas elas, e um conjunto grande desenhado para keto. Filtram-se por refeição, **por cozinha e por dieta** (os dois filtros combinam-se), ou por compatibilidade com quem está selecionado; há ainda a secção das receitas que servem as dietas de **todos ao mesmo tempo**. Cada receita mostra os ingredientes com as quantidades **já multiplicadas pelo número de pessoas** e com o estado da despensa — ✓ verde para o que já tens em casa, ✗ vermelho para o que falta — e uma etiqueta-resumo que diz «Pronta a cozinhar» quando não falta nada.

**Os macros saem dos ingredientes.** Cada um dos 221 ingredientes do catálogo tem composição por 100 g (energia, hidratos, proteína, gordura e fibra) na linha das tabelas de composição de alimentos, e o peso de uma unidade onde isso é preciso — um ovo, um dente de alho, um tomate. As calorias e os macros de todas as receitas são calculados a partir daí, incluindo a **parte edível**: compram-se 350 g de mexilhões e comem-se cerca de 100, e a lista de compras usa o primeiro número enquanto os macros usam o segundo. As etiquetas de dieta seguem o mesmo princípio — keto e low carb saem do hidrato líquido (total menos fibra), low fat da percentagem de gordura, e vegetariana e paleo do que a receita leva dentro. Nenhuma delas é escrita à mão, por isso nenhuma pode desalinhar-se do prato.

**As tuas receitas** — «+ Nova receita» abre um editor onde se escolhem ingredientes do catálogo, quantidades da receita inteira e quantas doses rende. Os macros por dose e as etiquetas de dieta aparecem **enquanto se escreve**, e a receita passa a viver na biblioteca como qualquer outra: entra nas sugestões, no plano, na despensa e na lista de compras. Qualquer receita da biblioteca se pode **copiar para editar**, e as da casa editam-se e apagam-se no próprio cartão — apagar uma receita liberta as refeições onde estava planeada, em vez de deixar um lugar vazio sem explicação. Só entram ingredientes do catálogo: é isso que garante que o nome bate certo com a despensa e que há composição para calcular.
...
**📅 Plano semanal** — pequeno-almoço, almoço, lanche e jantar para cada dia, escolhendo quem come cada refeição, com navegação entre semanas e preenchimento automático. Os **cheat days** marcam-se por pessoa e por dia: quem estiver de folga sai das contas e da lista de compras nesse dia.
...
**O que uma pessoa não come** — em Nutrição, ao lado do tipo de dieta, cada perfil marca as suas exclusões: os catorze alergénios de declaração obrigatória na União Europeia (glúten, lacticínios, ovo, peixe, crustáceos, moluscos, frutos de casca rija, amendoim, soja, sésamo, aipo, mostarda, tremoço) mais carne, porco, álcool e picante. Uma dieta vegetariana ou paleo acrescenta as suas exclusões sozinha. Qualquer receita com um ingrediente marcado deixa de ser sugerida a essa pessoa, na lista de receitas, no plano e no preenchimento automático — que cede na cozinha e no teto de calorias, mas nunca na dieta nem num ingrediente vetado.
